...
class EntriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'block_key' => ['type' => 'index', 'columns' => ['block_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'entries_ibfk_1' => ['type' => 'foreign', 'columns' => ['block_id'], 'references' => ['blocks', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2017-05-16 22:45:06',
            'modified' => '2017-05-16 22:45:06'
        ],
    ];
}
